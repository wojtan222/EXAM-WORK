Feature: Address Management
  ...
  Scenario Outline: User can add a new address
    ...
    And Checking if <expectedAlias> expectedAlias, <expectedAddress> expectedAddress, <expectedCity> expectedCity, <expectedZipCode> expectedZipCode, <expectedPhone> expectedPhone
